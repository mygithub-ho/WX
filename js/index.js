...
app.controller('mainCtrl',['$scope',function($scope){
 ...
 var lianxiren=[
   {tupian:"images/11.jpg",name:"吴昕",message:"你好",time:"9:30",liaotianjilu:[
   ...
   {tupian:"images/12.jpg",name:"陈妍希",message:"hello",time:"8:30",liaotianjilu:[
   ...
   {tupian:"images/13.jpg",name:"吴亦凡",message:"HI",time:"9:30",liaotianjilu:[
     {xinxi:'星期天',isMe:false},
     {xinxi:'事儿还是很多',isMe:true},
     {xinxi:'就说没办法啊',isMe:false},
     ] },
   {tupian:"images/14.jpg",name:"刘涛",message:"晚上好",time:"12:20",liaotianjilu:[
     {xinxi:'aaaa',isMe:false},
     {xinxi:'aaa',isMe:true},
     {xinxi:'aa',isMe:false},
     ] },
   {tupian:"images/15.jpg",name:"陈学冬",message:"中午好",time:"9:30",liaotianjilu:[
     {xinxi:'aaaa',isMe:false},
     {xinxi:'aaa',isMe:true},
     {xinxi:'aa',isMe:false},
     ] },
   {tupian:"images/16.jpg",name:"鹿晗",message:"欢挺",time:"10:50",liaotianjilu:[
     {xinxi:'aaaa',isMe:false},
     {xinxi:'aaa',isMe:true},
     {xinxi:'aa',isMe:false},
     ] },
